...
export default function DonateFund({ organizationID, fundID }) {
    ...
    const handleDonation = (e) => {
        ...
        if (donationAmount <= 0 || donationAmount === undefined) {
            setFormErrors({ ...formErrors, donationAmount: "Donation amount must be greater than 0" })
        }
        setIsSubmit(true);
    }
            ...
            <form className="text-start">
                ...
                <div className="row d-flex justify-content-center">
                    <div className='col-lg-4 col-md-4 col-sm-4'>
                        <button type="button" onClick={handleDonation} className="btn bg-gradient-primary w-100 my-4 mb-2">Donate</button>
                    </div>
                </div>
            </form>
        </div>
